...
export const mockOrders: Order[] = [
  ...
  },
  {
    ...
    status: "Completed",
    pickupWindowStart: set(today, { hours: 11, minutes: 0, seconds: 0 }).toISOString(),
    pickupWindowEnd: set(today, { hours: 12, minutes: 0, seconds: 0 }).toISOString(),
  ...
  },
  {
    ...
    status: "Pending",
    pickupWindowStart: set(today, { hours: 18, minutes: 0, seconds: 0 }).toISOString(),
    pickupWindowEnd: set(today, { hours: 19, minutes: 0, seconds: 0 }).toISOString(),
